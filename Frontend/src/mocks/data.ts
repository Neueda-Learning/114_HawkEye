...
export const mockAccounts: Account[] = [
  { accountId: 'ACC-001', accountName: "John Smith's Account",  accountType: 'PERSONAL',  dailyLimit: 50000,  status: 'ACTIVE',    createdAt: '2025-01-10T09:00:00Z', updatedAt: '2025-01-10T09:00:00Z' },
...
export const mockTransactions: TransactionResponse[] = [
  { transactionId: 1,  accountId: 'ACC-001', accountName: "John Smith's Account", payeeId: 'ACME-CORP',   payeeName: 'ACME Corporation', amount: 15000, currency: 'USD', transactionType: 'DEBIT',  status: 'COMPLETED', description: 'Vendor payment',      timestamp: '2026-01-22T14:28:30Z', createdAt: '2026-01-22T14:28:31Z' },
  { transactionId: 2,  accountId: 'ACC-001', accountName: "John Smith's Account", payeeId: 'TECH-LTD',    payeeName: 'Tech Ltd',         amount: 5000,  currency: 'USD', transactionType: 'DEBIT',  status: 'COMPLETED', description: 'Software license',    timestamp: '2026-01-22T14:15:00Z', createdAt: '2026-01-22T14:15:01Z' },
  ...
  { transactionId: 4,  accountId: 'ACC-001', accountName: "John Smith's Account", payeeId: 'SERVICES-CO', payeeName: 'Services Co',      amount: 2000,  currency: 'USD', transactionType: 'DEBIT',  status: 'COMPLETED', description: 'Consulting fee',      timestamp: '2026-01-22T13:20:10Z', createdAt: '2026-01-22T13:20:11Z' },
  ...
  { transactionId: 7,  accountId: 'ACC-001', accountName: "John Smith's Account", payeeId: 'NEW-VENDOR',  payeeName: 'New Vendor LLC',   amount: 12000, currency: 'USD', transactionType: 'DEBIT',  status: 'COMPLETED', description: 'New supplier',        timestamp: '2026-01-22T10:55:00Z', createdAt: '2026-01-22T10:55:01Z' },
  ...
  { transactionId: 10, accountId: 'ACC-001', accountName: "John Smith's Account", payeeId: 'SERVICES-CO', payeeName: 'Services Co',      amount: 1200,  currency: 'USD', transactionType: 'DEBIT',  status: 'FAILED',    description: 'Failed transaction',  timestamp: '2026-01-22T09:00:00Z', createdAt: '2026-01-22T09:00:01Z' },
...
export const mockAlerts: Alert[] = [
  { alertId: 1, ruleId: 1, ruleName: 'Amount > $10,000',      ruleType: 'AMOUNT_THRESHOLD', accountId: 'ACC-001', accountName: "John Smith's Account", transactionId: 1,  alertStatus: 'OPEN',          severity: 'HIGH',     alertMessage: 'Transaction $15,000 exceeds threshold $10,000',         alertDetails: { amount: 15000, threshold: 10000 }, createdAt: '2026-01-22T14:30:45Z', acknowledgedAt: null,                  investigatingAt: null,                  closedAt: null,                  closedReason: null, closedBy: null,         updatedAt: '2026-01-22T14:30:45Z' },
